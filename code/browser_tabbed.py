...
class AboutDialog(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        logo = QLabel()
        #logo.setPixmap(QPixmap(os.path.join('images', 'qt.jpg')))
        layout.addWidget(logo)

        layout.addWidget(QLabel("Version 1.1.0.0"))
        layout.addWidget(QLabel("Copyright 2021 hxzd5568."))
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.urlbar22.returnPressed.connect(self.navigate_to_debug)

        navtb2= QToolBar("input")
        navtb2.addWidget(self.urlbar22)
        self.addToolBar(navtb2)
        navtb = QToolBar("Navigation")
        navtb.setIconSize(QSize(31, 31))
        self.addToolBar(navtb)

        back_btn = QAction(QIcon(os.path.join('images', '后退.png')), "Back", self)
        back_btn.setStatusTip("Back to previous page")
        back_btn.triggered.connect(lambda: self.tabs.currentWidget().back())
        navtb.addAction(back_btn)

        next_btn = QAction(QIcon(os.path.join('images', '前进.png')), "Forward", self)
        next_btn.setStatusTip("Forward to next page")
        next_btn.triggered.connect(lambda: self.tabs.currentWidget().forward())
        navtb.addAction(next_btn)

        reload_btn = QAction(QIcon(os.path.join('images', '刷新.png')), "Reload", self)
        ...
        font = self.httpsicon.font()
        font.setPointSize(30)
        self.httpsicon.setFont(font)
        ...
        self.urlbar22.setFont(QFont("Timers" , 12 ));
        self.urlbar.setFont(QFont("Timers" , 12 ));
        ...
        new_tab_action.setStatusTip("Open a biying tab")
        new_tab_action.triggered.connect(lambda _: self.add_biying_tab())
        ...
        about_action = QAction(QIcon(os.path.join('images', 'question.png')), "About Code Helper", self)
        about_action.setStatusTip("Find out more about it")  # Hungry!
        ...
        self.setWindowTitle("Code Helper")
        self.setWindowIcon(QIcon(os.path.join('images', 'ch.jpg')))
    ...
    def add_biying_tab(self, q='https://cn.bing.com/', label="biying"):
    ...
    def update_title(self, browser):
        ...
        self.setWindowTitle("%s - Code-Helper" % title)

    def navigate_linux(self):
        
        browser = QWebEngineView()
        browser.setUrl(QUrl("https://man7.org/linux/man-pages/dir_section_1.html"))
    ...
    def navigate_to_debug(self):  # Does not receive the Url
        qurl = QUrl('')
        browser = QWebEngineView()
        browser.setUrl(qurl)
        ...
        if 'error' in q.lower() or 'warning' in q.lower():
            ...
            if 'py' in q.lower():
                ...
                browser = QWebEngineView()
                browser.setUrl(QUrl('https://duckduckgo.com/?sites=cppreference.com&q='+q+'&ia=web'))
                i = self.tabs.addTab(browser,'Creference')
